...
* ### GAN-based speech enhancement for CI users <a name="gan-enhancement"></a>
...
* ### CNN-based speech enhancement in CI auditory space <a name="cnn-enhancement"></a>
...
* ### Speech separation using probabilistic PIT <a name="pit"></a>
...
* ### Recognizing continuous emotion labels using MDS network <a name="mds-net"></a>
...
* ### Recognizing continuous emotion labels using large receptive field networks <a name="lr-nets"></a>
...
* ### Progressive neural networks for transfer learning in computational paralinguistics <a name="pnn"></a>
...
* ### Multimodal emotion recognition from speech and text <a name="multimodal"></a>
